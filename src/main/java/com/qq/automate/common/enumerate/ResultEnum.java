package com.qq.automate.common.enumerate;
...
public enum ResultEnum {
    ...
    USER_CAPTCHA_ERROR(20006, "验证码错误"),
    USER_CAPTCHA_NOT_EXIST(20007, "验证码不存在或已过期"),
    USER_REGISTER_FAIL(20007, "用户注册失败"),

    /* 系统错误：40001-49999 */
    FILE_MAX_SIZE_OVERFLOW(40003, "上传尺寸过大"),
    FILE_ACCEPT_NOT_SUPPORT(40004, "上传文件格式不支持"),
    ACCESS_LIMIT_REACHED(40005, "访问频率超过限制"),
