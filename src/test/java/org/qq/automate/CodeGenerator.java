...
public class CodeGenerator {
    ...
    public static void getCode() {
        // TODO 修改为自己的数据库信息
        String url = "jdbc:mysql://localhost:3306/qq_data?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "123456";
        // TODO 修改为自己的表名
        List<String> tables = List.of("yiguan_mood","flight_history_price");// 需要生成对应代码的表名的集合

        FastAutoGenerator.create(url, username, password)
                // 全局配置----------------------------------------------------------------------------------------
                .globalConfig(builder -> {
                    builder
                            .author("Q")// TODO 修改为自己名称
                            .outputDir(System.getProperty("user.dir") + "\\src\\main\\java")// 输出路径(写到java目录)
                            // .enableSwagger() //开启swagger，会自动添加swagger相关注解
                            .commentDate("yyyy-MM-dd HH:mm:ss");// 日期格式
                ...
                .packageConfig(builder ->
                        builder.parent("com.qq.automate")// TODO 修改为自己项目的路径
